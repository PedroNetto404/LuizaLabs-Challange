...
public sealed class GetAllProductsSpecification : Specification<Product>
{
    private static readonly IDictionary<string, Expression<Func<Product, object>>> AllowedSortValues =
